            ...
            >
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 items-start'>
                <Input
                  ...
                  value={lang.name || ""}
                  onChange={({ target }) =>
                    updateArrayItem("languages", "name", index, target.value)
                  }
                />
                ...
                <div>
                  ...
                  <RatingInput
                    ...
                    onChange={(value) =>
                      updateArrayItem("languages", "progress", index, value)
                    }
                    total={5}
                    activeColor="#0ea5e9"
          ...
          {interests?.map((interest, index) => (
            ...
            >
              <Input
                ...
                value={interest || ""}
                onChange={({ target }) =>
                  updateArrayItem("interests", null, index, target.value)
                }
              />
              ...
              {interests.length > 1 && (
                <button
                  type='button'
                  className='absolute top-7 right-3 text-sm text-red-600 hover:underline cursor-pointer'
